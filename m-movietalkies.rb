...
#movie = "@| #{doc.css('span#ctl00_ContentPlaceHolder1_MovieNamePlate1_lblMovieName').text}|#{doc.css('span#ctl00_ContentPlaceHolder1_MovieMainDetails1_lblMovieReleaseDate').text}|#{doc.css('span#ctl00_ContentPlaceHolder1_MovieMainDetails1_lblAverageRate').text}|#{doc.css('span#ctl00_ContentPlaceHolder1_MovieMainDetails1_lblRateCount').text}|"
...
doc.css('table#ctl00_ContentPlaceHolder1_MovieMainDetails1_DataList_MovieDirector').children.css('a').each do |a| 
 ...
 d_name = a.text
 director = director + '{"d_id":"' + d_id + '","d_name":"' + a.text + '"},'
end
...
doc.css('table#ctl00_ContentPlaceHolder1_MovieMainDetails1_DataList_Producer').children.css('a').each do |a| 
 ...
 p_name = a.text
 producer = producer + '{"p_id":"' + p_id + '","p_name":"' + a.text + '"},'
end
...
#puts movie_id + "|" + movie + genre + director  + producer